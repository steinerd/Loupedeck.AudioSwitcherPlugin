namespace Loupedeck.Steinerd.AudioSwitcherPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.Steinerd.AudioSwitcherPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.Steinerd.AudioSwitcherPlugin.Resources.Resource.txt`.
